...
public class BookController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<BookResponseDTO>> getBookByTitle(@RequestParam(value = "q", required = false) String q) {
        List<BookResponseDTO> books = bookService.getBooksByFilters(q);
